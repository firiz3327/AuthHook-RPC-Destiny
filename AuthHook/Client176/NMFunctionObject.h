...
public:
	...
	enum NMSTATTYPE
	{
		...
		kStatType_TrayLClick,		// Ʈ���� - ��Ŭ�� (�˾��޴� ���)
		kStatType_TrayRClick,		// Ʈ���� - ��Ŭ�� (�˾��޴� ���)
		kStatType_TrayDClick,		// Ʈ���� - ����Ŭ�� (���� â ����)

		kStatType_FriendTabClick,	// ģ��/��� ����Ʈ - ģ�� �� Ŭ��
		...
		kStatType_LoginToastClick,	// �佺Ʈ - �α��� �佺Ʈ Ŭ��
		kStatType_GameStartToastClick,	// �佺Ʈ - ���ӽ��� �佺Ʈ Ŭ��
		kStatType_LevelUpToastClick,	// �佺Ʈ - ������ �佺Ʈ Ŭ��

		// Plug - Status			// �޽��� �α� ������ �����ϸ� �α��κ� 1ȸ ����
		kStatType_MainPosition,		// ȯ�漳���� ���� â ��ġ (�α��κ� 1ȸ ����)
		kStatType_FriendListSize,	// ȯ�漳���� ģ�� ����Ʈ ũ��/��ġ (Data1: ũ��, Data2: �Ʒ�(0), ��(1))
		kStatType_FriendGroupingMethod,	// ȯ�漳���� ģ������Ʈ ���� ��� (Data1: ���º�(0), �׷캰(1))
